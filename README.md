...
`github.com/powerslacker/logrus`. Any package that isn't, should be changed.

To fix Glide, see [these
comments](https://github.com/powerslacker/logrus/issues/553#issuecomment-306591437).
For an in-depth explanation of the casing issue, see [this
comment](https://github.com/powerslacker/logrus/issues/570#issuecomment-313933276).
...
the lower-case import: `github.com/powerslacker/logrus`.
...
replace your `log` imports everywhere with `log "github.com/powerslacker/logrus"`
...
import (
  ...
  logrus_syslog "github.com/powerslacker/logrus/hooks/syslog"
  "log/syslog"
)
...
A list of currently known of service hook can be found in this wiki [page](https://github.com/powerslacker/logrus/wiki/Hooks)
...
* `logrus.TextFormatter`. Logs the event in colors if stdout is a tty, otherwise
  ...
  * All options are listed in the [generated docs](https://godoc.org/github.com/powerslacker/logrus#TextFormatter).
* `logrus.JSONFormatter`. Logs fields as JSON.
  * All options are listed in the [generated docs](https://godoc.org/github.com/powerslacker/logrus#JSONFormatter).
...
import(
  "github.com/powerslacker/logrus"
  "github.com/powerslacker/logrus/hooks/test"
